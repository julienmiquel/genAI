...
st.header("Vertex AI Search Demo", divider="rainbow",)
...
<gen-search-widget
  configId="664e03d4-1a0d-4d7f-8dfe-4849f43ece83"
  triggerId="searchWidgetTrigger">
</gen-search-widget>

<!-- Element that opens the widget on click. It does not have to be an input -->
<input placeholder="Search here" id="searchWidgetTrigger" />""" , width=1000, height=500, scrolling=False) 
